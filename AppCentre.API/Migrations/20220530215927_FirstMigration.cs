    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetApplications", x => x.ApplicationsID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NN = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ApplicationsID = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_AspNetApplications_ApplicationsID",
                        column: x => x.ApplicationsID,
                        principalTable: "AspNetApplications",
                        principalColumn: "ApplicationsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_ApplicationsID",
                table: "AspNetRoles",
